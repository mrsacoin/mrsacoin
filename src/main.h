...
static const uint256 hashGenesisBlock("000006fd7eb253f2a453b6746f4f1a67b66d5fe3c15f8d158fa4ff7e3afce8d6");
static const uint256 hashGenesisBlockTestNet("000006fd7eb253f2a453b6746f4f1a67b66d5fe3c15f8d158fa4ff7e3afce8d6");
...
public:
    ...
    {
        // MrsaCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // MrsaCoin: get transaction coin age
...
public:
    ...
    // MrsaCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // MrsaCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // MrsaCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // MrsaCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // MrsaCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // MrsaCoin: block index flags
    enum  
    {
